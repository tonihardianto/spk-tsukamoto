										...
										<div class="col-md-12 col-sm-12">
											...
											<div class="x_panel">
												...
												<div class="x_content1">
													<button data-target="#tambahdata" data-toggle="modal"
														class="btn btn-info"><i class="fa fa-pen-to-square"></i> Input
														Permintaan</button>
													<button data-target="#tambahsedia" data-toggle="modal"
														class="btn btn-warning"><i class="fa fa-pen-to-square"></i>
														Input Persediaan</button>
