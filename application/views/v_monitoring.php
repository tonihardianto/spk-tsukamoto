				...
				<div class=""></div>
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <form method="GET" action="<?php echo base_url('monitor/show') ?>">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="<?= base_url('monitor') ?>" class="btn btn-danger">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<div style="text-align: right;">
										<button class="btn btn-info" data-toggle="modal" data-target="#print"> Print <i class="fa fa-print"></i></button>
									</div>
									<div class="clearfix"></div>
									<br />
									<!-- content here -->
            	...
            	<div class="modal-dialog modal-md">
            		<div class="modal-content">
            			...
            			<div class="modal-body">
                            ...
                            <div class="x_content">
									<br />
									<form method="POST" action="<?php echo base_url('report/printO') ?>" id="form-hitung" target="_blank" data-parsley-validate autocomplete="off" class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											<label for="" class="col-form-label col-md-3 col-sm-3 label-align"> Pilih Cabang</label>
											<div class="col-md-8 col-sm-8 ">
											<select name="user" id="user" class="form-control">
												<option value="">--Pilih Cabang--</option>
												<?php foreach($cabang2 as $i): ?>
													<option value="<?= $i['user_fullname'] ?>"><?= $i['user_fullname'] ?></option>
												<?php endforeach; ?>
											</select>
											</div>
										</div>
